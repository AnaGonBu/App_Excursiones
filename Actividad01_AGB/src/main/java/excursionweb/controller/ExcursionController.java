...
public class ExcursionController {
	...
	public String findByTerminado(Model model) {
		if (edao.findByTerminados().size()>0) {
		model.addAttribute("excursiones",edao.findByTerminados());
		model.addAttribute("mensaje", "Excursiones Terminadas");
		return "detalleEstados";
		}else
